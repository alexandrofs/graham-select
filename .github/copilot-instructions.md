...
- **Output Folder**: {project-root}/docs/bmad
- **Planning Artifacts**: {project-root}/docs/bmad/planning-artifacts
- **Implementation Artifacts**: {project-root}/docs/bmad/implementation-artifacts
